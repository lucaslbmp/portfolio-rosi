...
const SectionHero = () => {
  return (
    <section
      className="p-10 flex flex-wrap justify-center h-[400px] bg-[url:theme('backgroundImage.hero-image')] bg-bottom bg-col bg-no-repeat bg-cover text-foregroundTertiary relative"
      id="hero"
    >
